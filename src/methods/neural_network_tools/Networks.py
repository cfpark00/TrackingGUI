...
class ThreeDCN(nn.Module):
    def __init__(self, n_channels=3,n_filt_init=16,growth=24,kernel_size=3,compress_targ=32,num_classes=10):
        ...
        n_filt_in=n_filt
        n_filt+=growth
        self.aspp2=ASPP(n_filt_in,n_filt, atrous_rates=((3,3,1),(6,6,2),(9,9,3)))
        self.compressionaspp2conv=nn.Conv3d(n_filt, compress_targ, kernel_size=1, stride=1,bias=False)
        ...
        n_filt_in=n_filt
        n_filt+=growth
        self.aspp3=ASPP(n_filt_in,n_filt, atrous_rates=((3,3,1),(6,6,1),(9,9,2)))
        self.compressionaspp3conv=nn.Conv3d(n_filt, compress_targ, kernel_size=1, stride=1,bias=False)
        ...
        n_filt_in=n_filt
        n_filt+=growth
        self.aspp4=ASPP(n_filt_in,n_filt, atrous_rates=((2,2,1),(3,3,1),(4,4,2),(5,5,2)))
        self.compressionaspp4conv=nn.Conv3d(n_filt, compress_targ, kernel_size=1, stride=1,bias=False)
